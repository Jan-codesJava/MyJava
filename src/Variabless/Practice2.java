...
public class Practice2 {
    ...
    public static void main(String[] args){
        ...
        System.out.println("Total number of fruits ="+apples+oranges+kiwi);//Total number
        ...
        System.out.println("The total number od apples and kiwis is " + (apples+kiwi)+ " and difference between kiwi and orange is " + (kiwi-oranges));
