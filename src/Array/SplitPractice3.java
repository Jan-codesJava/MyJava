...
public class SplitPractice3 {
    public static void main(String[] args) {
        ...
        String text = "Eagles are large, powerfully built birds of prey, " +
                ...
                "from their prey, strong, muscular legs, and powerful talons. The beak isn" +
        ...
        System.out.println(count); //116 - amount of even words from the text
        System.out.println(splitText.length); //out 0f 257 letters
    }
}