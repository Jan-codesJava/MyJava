...
public class ElseIfPractice {
    public static void main(String[] args) {
        ...
        if the number falls in to range of 0 to 5 -->
        if the number falls in to range of 6 to 10 -->
        if the number falls in to range of 11 to 15 -->
        if the number falls in to range of 16 to 20 -->
